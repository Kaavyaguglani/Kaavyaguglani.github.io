...
<body style="background-color:rgb(200, 224, 224);">
...
<section class="transfer-navbar">
	...
	<div class="container" style="background-color:rgb(200, 224, 224);">
        <h2 class="text-center pt-4 transfer-heading" >TRANSACTION HISTORY</h2>
